...
def carregar_dados_iniciais():
    ...
    livros.extend([
        ...
        Livro("Fundação", "Isaac Asimov", 1951),
        Livro("Neuromancer", "William Gibson", 1984),
        Livro("O Fim da Infância", "Arthur C. Clarke", 1953),
        Livro("Snow Crash", "Neal Stephenson", 1992),
        Livro("2001: Uma Odisseia no Espaço", "Arthur C. Clarke", 1968),
        Livro("Eu, Robô", "Isaac Asimov", 1950),
        Livro("Hyperion", "Dan Simmons", 1989),
        Livro("Guerra dos Mundos", "H. G. Wells", 1898),
        Livro("O Guia do Mochileiro das Galáxias", "Douglas Adams", 1979),
    ])

    usuarios.extend([
        Usuario("Gabriel Ramos", "U001"),
        Usuario("Hércules Rossi", "U002"),
        Usuario("Lucas Leandro", "U003"),
        Usuario("Luiz Fernando", "U004"),
        Usuario("Wesley Rabelo", "U005"),
    ])
